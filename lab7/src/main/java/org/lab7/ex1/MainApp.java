...
public class MainApp {
    public static Map<Integer, Carte>  citire() {
        try{
            ...
            Map<Integer, Carte> carti_map = mapper.readValue(new File("/Users/ioanadragomir/Documents/lab7/src/main/resources"), new TypeReference<Map<Integer, Carte>>(){});
            return carti_map;
    ...
    public static void scriere(Map<Integer, Carte> carti) {
        try {
            ObjectMapper mapper = new ObjectMapper();
            File fis = new File("/Users/ioanadragomir/Documents/lab7/src/main/resources");
